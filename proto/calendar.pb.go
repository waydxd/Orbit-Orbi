...
func (x *GetAvailableSlotsResponse) Reset() {
	*x = GetAvailableSlotsResponse{}
	mi := &file_proto_calendar_proto_msgTypes[11]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GetAvailableSlotsResponse) Descriptor() ([]byte, []int) {
	return file_proto_calendar_proto_rawDescGZIP(), []int{11}
}
...
func (x *GetUserAvailabilityResponse) Reset() {
	*x = GetUserAvailabilityResponse{}
	mi := &file_proto_calendar_proto_msgTypes[16]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GetUserAvailabilityResponse) Descriptor() ([]byte, []int) {
	return file_proto_calendar_proto_rawDescGZIP(), []int{16}
}
...
func (x *QueryEventsRequest) Reset() {
	*x = QueryEventsRequest{}
	mi := &file_proto_calendar_proto_msgTypes[17]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*QueryEventsRequest) Descriptor() ([]byte, []int) {
	return file_proto_calendar_proto_rawDescGZIP(), []int{17}
}
...
func (x *QueryEventsResponse) Reset() {
	*x = QueryEventsResponse{}
	mi := &file_proto_calendar_proto_msgTypes[18]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*QueryEventsResponse) Descriptor() ([]byte, []int) {
	return file_proto_calendar_proto_rawDescGZIP(), []int{18}
}
...
const file_proto_calendar_proto_rawDesc = "" +
	...
	"\vQueryEvents\x12\x1c.calendar.QueryEventsRequest\x1a\x1d.calendar.QueryEventsResponseB&H\x03Z\"github.com/waydxd/Orbit-Orbi/protob\x06proto3"
...
var file_proto_calendar_proto_msgTypes = make([]protoimpl.MessageInfo, 19)
